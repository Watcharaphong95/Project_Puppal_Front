...
class _ClinicmainbottomnavigateState extends State<Clinicmainbottomnavigate> {
  ...
  final navController = Get.find<Mainclinicnavigatecontroller>();
  ...
  Widget? buildAppBar() {
    ...
    bool hasPage = navController.dynamicPages.containsKey(index) ||
        (index >= 0 && index < navController.pageTitles.length) ||
    ...
    return AppBar(
      ...
      title: Text(
        index < navController.pageTitles.length
            ? navController.pageTitles[index] ?? ''
            : '',
        style: TextStyle(
          color: Colors.white,
          fontSize: 24,
                        ...
                        if (resGeneral.statusCode == 200) {
                          showAlert(
                            ...
                            onConfirm: () {
                              ...
                              Get.offAll(() =>
                                  GeneralMainBottomNavigate(indexPage: 1));
                            },
                          );
                        } else {
                          showAlert(
